...
class OnlineTest extends JFrame implements ActionListener
{
	...
	void set()
	{
		...
		if(current==4)
		{
			l.setText("Que5: Evaluate the following Java expression, if x=3, y=5, and z=10: ++z + y - y + z + x++");
		...
		if(current==8)
		{
			l.setText("Que9: What is the return type of the hashCode() method in the Object class?");
